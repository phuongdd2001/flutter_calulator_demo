import 'package:flutter_calulator_demo/colors.dart';
import 'package:flutter_calulator_demo/utils.dart';
...
class ButtonWidget extends StatelessWidget {
  ...
  const ButtonWidget({super.key, required this.text, required this.onClicked, required this.onClickedLong});
